...
public class Warehouse {
	...
	public void displayProcessors() {
		for (ComputerComponent computerComponent : computerComponents) {
			if (computerComponent instanceof Processor) {
				System.out.println(computerComponent.getShortDescription());
			}
	...
	public void displayComputerCases() {
		for (ComputerComponent computerComponent : computerComponents) {
			if (computerComponent instanceof ComputerCase) {
				System.out.println(computerComponent.getShortDescription());
			}
	...
	public void displayPeripherals() {
		for (ComputerComponent computerComponent : computerComponents) {
			if (computerComponent instanceof Peripheral) {
				System.out.println(computerComponent.getShortDescription());
			}
